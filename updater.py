...
readme = """[How do I claim a bounty?](http://www.chaintip.org/github#claim-bounty) |  [How do I create or add to a bounty?](http://www.chaintip.org/github#tip-issue) | [chaintip.org](http://www.chaintip.org/)
## Available Bounties
...
for issue in bounties_repo.get_issues(state='open'):
    ...
    if i:
        ...
        repo_string += " /"
        repo_string += " " if (len(split[0]) + len(split[1])) < 21 else "<br>"
