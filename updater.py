...
readme = """This repository tracks bounties on issues tipped using the ChainTip GitHub bot. Each open issue on this repo gives information about a bounty available on an issue in another repository.
